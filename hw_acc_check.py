...
text_lists = list(file for file in os.listdir(path) if file.endswith(".txt"))
...
for text in text_lists:
    ...
    acc_vietrain = sequence_matcher("vie_train_hw_result/" + text, "hw_data/" + text)
    acc_viehw = sequence_matcher("vie_hw_hw_result/" + text, "hw_data/" + text)
